---
title: "Analyse predictons of annual mesopelagic DOC"
...
#|cache: false
source("utils.R")
load("data/04.doc_meso_anno_pred.Rdata")
```
...
rsquares <- preds %>%
  ...
  rsq(truth = log_doc_meso, estimate = .pred)
...
preds %>%
  ggplot() +
  geom_point(aes(x = log_doc_meso, y = .pred, colour = cv_type)) +
