...
We want the response variable to be \~normally distributed. Let’s plot the distribution of log_doc_surf.
...
Let’s define a boosted regression trees model, with tunable hyperparameters:
