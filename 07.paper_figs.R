...
ps1a <- df_ann_surf_fit %>% 
  ...
  #geom_point(aes(x = lon, y = lat, colour = doc_surf), size = 0.5) +
  #ggplot2::scale_colour_viridis_c(option = "F", trans = "log1p", limits = doc_lims) +
  labs(colour = "DOC<br>(μmol kg<sup>-1</sup>)") +
...
ps1b <- df_ann_meso_fit %>% 
  ...
  geom_polygon(data = world, aes(x = lon, y = lat, group = group), fill = "grey") +
  geom_point(aes(x = lon, y = lat), size = 0.5, shape = 1, alpha = 0.5) +
  #geom_point(aes(x = lon, y = lat, colour = doc_meso), size = 0.5) +
  #ggplot2::scale_colour_viridis_c(option = "F", trans = "log1p", limits = doc_lims) +
  labs(colour = "DOC<br>(μmol kg<sup>-1</sup>)") +
  coord_quickmap(expand = c(0)) +
  scale_xy_map() +
...
ps1c <- df_ann_bathy_fit %>% 
  ...
  geom_polygon(data = world, aes(x = lon, y = lat, group = group), fill = "grey") +
  geom_point(aes(x = lon, y = lat), size = 0.5, shape = 1, alpha = 0.5) +
  #geom_point(aes(x = lon, y = lat, colour = doc_bathy), size = 0.5) +
  #ggplot2::scale_colour_viridis_c(option = "F", trans = "log1p", limits = doc_lims) +
  labs(colour = "DOC<br>(μmol kg<sup>-1</sup>)") +
  coord_quickmap(expand = c(0)) +
  scale_xy_map() +
...
ps5 <- ps5a / ps5b / ps5c + plot_annotation(tag_levels = "a")
ps5